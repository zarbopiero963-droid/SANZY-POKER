...
- [ ] **Retention/cleanup righe Postgres (#30):** la `password` di sessione persiste in `nda_signatures`; va data una scadenza/cleanup delle righe insieme alla sessione server-authoritative (PR3 punto 2), così il token non resta a tempo indefinito nel DB durevole.
